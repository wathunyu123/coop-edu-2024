  ...
  return (
    <nav>
      ...
      <div className="grid grid-cols-12 gap-4 min-h-screen py-6 ">
        {/* Sidebar */}
        <div className="text-center col-start-1 col-span-3 h-3/4 bg-white p-6 rounded-3xl w-[250px]">
          ...
          <div className="flex flex-col justify-center items-start my-auto">
            <div className="py-2 px-8 my-5 w-full rounded-xl hover:bg-cyan-700 hover:text-white">
