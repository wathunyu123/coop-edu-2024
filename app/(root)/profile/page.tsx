...
import { useSearchParams } from 'next/navigation'; // ใช้ useSearchParams แทน useRouter
...
export default function Profile() {
    const searchParams = useSearchParams(); // ดึงข้อมูล query string
            ...
            <div className="flex flex-col lg:flex-row bg-gray-200 px-16 py-20 mt-10 rounded-xl shadow-2xl justify-center items-center">
                ...
                <div className="flex flex-col w-full lg:w-2/3 bg-white p-6 rounded-lg shadow-md divide-y divide-gray-300">
                    <div className="flex justify-between py-4">
                        ...
                        <span className="text-gray-800 font-semibold">{name || "ไม่ระบุ"}</span>
                    </div>
                    <div className="flex justify-between py-4">
                    ...
                    <div className="flex justify-between py-4">
                        ...
                        <span className="text-gray-800 font-semibold">{phoneNumber || "ไม่ระบุ"}</span>
                    </div>
                    <div className="flex justify-between py-4">
